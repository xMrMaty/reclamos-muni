...
import { IonPage, IonContent, IonHeader, IonToolbar, IonGrid, IonRow, IonCol, IonCard, IonIcon, IonButton, IonBadge, IonAvatar, IonSelect, IonSelectOption, IonItem, IonSplitPane, IonMenu, IonList, IonLabel } from '@ionic/react';
import { documentTextOutline, locationOutline, timeOutline, saveOutline, settingsOutline, gridOutline, listOutline, barChartOutline, logOutOutline } from 'ionicons/icons';
    ...
    <IonSplitPane contentId="main-content" style={{ '--side-width': '250px' }}>
      ...
      <IonPage id="main-content">
        <IonHeader className="ion-no-border" style={{ borderBottom: '1px solid #eee' }}>
          {/* El botón "Volver a Gestión de Reclamos" fue eliminado */}
          <IonToolbar style={{ padding: '15px 20px' }}>
